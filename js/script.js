...
=======
   ...
   setTimeout(() => {
>>>>>>> 138608eef2686e4125d1fceaff981cbb9764eda1
      gridTable.innerHTML = "";
      ...
      for (let i = 1; i <= lastDay; i++) {
        ...
        if (
          ...
          document.getElementById("eventDayName").innerHTML =
            selectedDate.toLocaleString("eu-EU", {
              month: "long",
              day: "numeric",
              year: "numeric",
            });
...
function showEvents() {
  ...
  if (objWithDate) {
    ...
    emptyMessage.innerHTML = "Ez dago gertaerarik haukeratutako datan";
    sidebarEvents.appendChild(emptyMessage);
    let emptyFormMessage = document.getElementById("emptyFormTitle");
    emptyFormMessage.innerHTML = "Ez dago gertaerarik";
  }
}
